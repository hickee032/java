...
public class WrapperExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("문자 c를 숫자로 변환하여 출력 : "+Character.getNumericValue(c));
		System.out.println("문자열 “-123”을 정수로 변환하여 출력 : "+Integer.valueOf("-123"));
		System.out.println("16진수로 표현된 문자열 “10”을 정수로 변환하여 출력 : "+Integer.parseInt("10", 16));
		...
		System.out.println("i값(=10)을 double로 변환하여 출력 : "+i.doubleValue());
