...
public class CheckBoxExample {
	...
	public static void main(String[] args) {
		...
		/*
		 * Frame의 LayoutManager를 FlowLayout으로 설정한다. FlowLayout방식은 배치의 한 방식으로 좌측에서 우측으로
		 * 컴포넌트를 정렬시킨다. 지금은 왼쪽 정렬을 선택했다.
		 */
		...
		// Checkbox를 생성하여 소속을 group1으로 만든다. true는 기 선택된 값을 의미한다.
		...
		// Checkbox를 생성하여 소속을 group2으로 만든다. true는 기 선택된 값을 의미한다.
